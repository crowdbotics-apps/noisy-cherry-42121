"""
Django settings for noisy_cherry_42121 project.
...
ROOT_URLCONF = 'noisy_cherry_42121.urls'
...
WSGI_APPLICATION = 'noisy_cherry_42121.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_cherry_42121 API",
    "DESCRIPTION": "API documentation for noisy_cherry_42121 App",
    "VERSION": "v1",
}
